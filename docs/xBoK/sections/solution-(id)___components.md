...
- ## 🔑 Keys
  - #block [[solution-(id)/components]] > #key 💰20 [Appropriate Solution Components](https://go.plastilinn.com/#/page/solution-%28id%29%2Fcomponents%2FAppropriate%20Solution%20Components) {{renderer :slider_rjxyar}} [:span {:is "slider-rjxyar"}] 
    key-weight:: 20
    value:: 50
- ## 🤖 innCoPilot
