...
- ## 🔑 Keys
  - #block [[solution-(id)/pricing]] > #key 💰55 [Adecuate pricing](https://go.plastilinn.com/#/page/solution-%28id%29%2Fpricing%2FAdecuate%20pricing) {{renderer :slider_rjxyar}} [:span {:is "slider-rjxyar"}] 
    key-weight:: 55
    value:: 50
  - #block [[solution-(id)/pricing]] > #key 💰40 [Competitive pricing](https://go.plastilinn.com/#/page/solution-%28id%29%2Fpricing%2FCompetitive%20pricing) {{renderer :slider_rjxyar}} [:span {:is "slider-rjxyar"}] 
    key-weight:: 40
    value:: 50
- ## 🤖 innCoPilot
